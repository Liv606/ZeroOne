...
abstract class Styles {
  static const TextStyle pedidoNomeCliente = TextStyle(
  ...
  static const TextStyle whastapp = TextStyle(
    color: Color.fromRGBO(72, 165, 18, 0.8),
    fontSize: 18,
    fontStyle: FontStyle.normal,
    fontWeight: FontWeight.normal,
  );
  ...
  static const TextStyle textoError =
      TextStyle(color: Colors.red, fontWeight: FontWeight.w300, fontSize: 24);
